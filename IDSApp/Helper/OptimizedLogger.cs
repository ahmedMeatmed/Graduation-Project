...
namespace IDSApp.Helper
{
    ...
    public static class OptimizedLogger
    {
        ...
        private static readonly bool EnableDebugLogs = false;     // Reduced: disable debug logs
        ...
        public static LogLevel CurrentLogLevel { get; set; } = LogLevel.IMPORTANT;
        ...
        {
            if (!EnableRuleLogs || CurrentLogLevel < LogLevel.IMPORTANT) return;
